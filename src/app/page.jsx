    ...
    <div>
      <main>
        <div className="flex items-center justify-center flex-col h-screen">
          ...
          <div className="text-sm md:text-lg text-neutral-400  max-w-xs md:max-w-2xl text-center">
          ...
          <Link href="/login">
            <Button
              label="JOIN US"
              className="bg-primary hover:bg-teal-700 text-white font-bold py-2 px-4 rounded mt-4"
            ></Button>
          </Link>
        </div>
      </main>
